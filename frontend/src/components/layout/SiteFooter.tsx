        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground font-light">
              ...
              <li><Link href="/nosotros#mision" className="hover:text-primary transition-colors">Nuestra Misión</Link></li>
              <li><Link href="/nosotros#vision" className="hover:text-primary transition-colors">Nuestra Visión</Link></li>
              <li><Link href="/#servicios" className="hover:text-primary transition-colors">Portafolio de Servicios</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground font-light">
              <li><Link href="/legal/privacidad" className="hover:text-primary transition-colors">Políticas de Privacidad</Link></li>
              ...
              <li><Link href="/legal/tratamiento-datos" className="hover:text-primary transition-colors">Tratamiento de Datos</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground font-light">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@ssterraconsultores.com" className="hover:text-primary transition-colors">info@ssterraconsultores.com</a>
              </li>
              <li className="flex items-center gap-3">
