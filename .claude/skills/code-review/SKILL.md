---
name: code-review
description: "Review the current diff against path-scoped rules: secrets, RLS/tenant scoping, Stripe webhook verification and idempotency, input validation, and scope. Reports findings; nothing auto-fixed without approval."
