...
description: "Check GDPR and SOC 2-lite readiness: inventory PII, verify privacy policy and data-subject rights paths, map subprocessors, and produce a PASS/GAP report per item."
